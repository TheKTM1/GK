...
public class TransformedShapes extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		//tworzenie dwóch kwadratów w górnej czêœci figury
		g2.setColor(Color.GREEN);
		g2.translate(400, 100);
		square();
		...
		//tworzenie dwóch kwadratów w dolnej czêœci figury
		g2.translate(0, 100);
		square();
		...
		//rysowanie bia³ego trójk¹ta na dolnych kwadratach:
